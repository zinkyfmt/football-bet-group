...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/img/logo1.png') }}" width="118" height="46" alt="Euro Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('/assets/img/logo1.png') }}" width="118" height="46" alt="Euro Logo">
        </div>
